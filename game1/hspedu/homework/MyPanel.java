...
//        drawTank(myTank.getX() + 100, myTank.getY(), g, 1, 1);
//        drawTank(myTank.getX() + 200, myTank.getY(), g, 2, 1);
//        drawTank(myTank.getX() + 300, myTank.getY(), g, 3, 1);
    ...
    @Override
    public void keyPressed(KeyEvent e) {//处理键==>当摁键时会自动移动。
        if (e.getKeyCode() == KeyEvent.VK_W) {
            //摁下W键，就改变坦克的方向。===>所以要把方向做成一个变量==>成员属性
